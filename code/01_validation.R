...
#example using ryegrass data
my_suitcase <- validate_data(ryegrass, 
                             target_dose_col="conc", 
                             target_response_col="rootl"
)

# Decision Gate
if(my_suitcase$status=="Success"){
  # Proceed to Script 02: EDA
} else{
  # Stop and show the report
  cat(my_suitcase$message)
}
